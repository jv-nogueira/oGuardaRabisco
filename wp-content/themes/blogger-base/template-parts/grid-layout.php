...
<div class="col-lg-4 col-md-4">
    <div class="blog-sec p-3 mb-4 text-center">
        ...
        <div class="entry-content"><p><?php $blogger_base_excerpt = get_the_excerpt(); echo esc_html( blogger_base_string_limit_words( $blogger_base_excerpt, esc_attr(get_theme_mod('blogger_hub_post_excerpt_number','20')))); ?></p></div>
