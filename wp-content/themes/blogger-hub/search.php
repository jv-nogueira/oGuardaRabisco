            ...
            <div class="container">  
                <div class="row">      
                    <div class="col-lg-9 col-md-9">
                        <h1 class="search-title mb-3 text-center"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','blogger-hub'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
