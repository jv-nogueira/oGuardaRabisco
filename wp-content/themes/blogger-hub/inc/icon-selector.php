...
class Blogger_Hub_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'blogger-hub'); ?>">
                      </div>
                    <?php
                    $blogger_hub_font_awesome_icon_array = blogger_hub_font_awesome_icon_array();
                    foreach ($blogger_hub_font_awesome_icon_array as $blogger_hub_font_awesome_icon) {
                            $icon_class = $this->value() == $blogger_hub_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($blogger_hub_font_awesome_icon).'"></i>
                            <span class="blogger-hub-social-class">'.esc_attr($blogger_hub_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function blogger_hub_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'blogger_hub_customizer_script' );

if(!function_exists('blogger_hub_font_awesome_icon_array')){
    function blogger_hub_font_awesome_icon_array(){
