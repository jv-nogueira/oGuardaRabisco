...
<div class="wrapper-info">
	<div class="col-left">
		...
		<div class="color_bg_blue">
			...
			<div class="coupon-code"><?php esc_html_e( 'Get', 'blogger-hub' ); ?> <span><?php esc_html_e( '20% off', 'blogger-hub' ); ?></span> <?php esc_html_e( 'on Premium Theme with the discount code: ', 'blogger-hub' ); ?> <span><?php esc_html_e( '" Get20 "', 'blogger-hub' ); ?></span></div>
		</div>
		<div class="started">
